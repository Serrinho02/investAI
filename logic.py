...
# --- DATABASE MANAGER (Versione Anti-Crash & Cloud) ---
class DBManager:
    def __init__(self):
        ...
        if self.conn is not None:
            ...
            print("⚠️ ERRORE CRITICO: DB non connesso. L'app funzionerà senza DB.")
    ...
    def get_cursor(self):
        # Se la connessione è None (fallita in partenza), ritorniamo None e basta.
        if self.conn is None: 
            return None
            
        try:
            # Riconnessione automatica se cade la linea (solo Postgres)
